...
const fdContainer= document.querySelector('.fdcontainer');
const fooditem=[
    {
        FoodName: "Cheese paratha",
        foodimg: 'images/item-1.jpeg',
        price: "RS 250",
        type: "breakFast",
...
const listItems = ` <div class="${item.type} menu-items  foodbox d-flex justify-content-between  mx-3 my-4" style="width: 40rem;">
...
`;
fdContainer.innerHTML += listItems;
